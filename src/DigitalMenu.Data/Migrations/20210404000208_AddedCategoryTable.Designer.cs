...
namespace DigitalMenu.Data.Migrations
{
    ...
    [Migration("20210404000208_AddedCategoryTable")]
            ...
            modelBuilder.Entity("DigitalMenu.Entity.Entities.Culture", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1a8953e3-aa5e-4a83-8be3-becee9432748"),
                            CultureCode = "tr",
                            IsDefaultCulture = true
                        },
                        new
                        {
                            Id = new Guid("82baa84e-7c8c-4edc-a097-2734d32e237a"),
                            CultureCode = "en",
            ...
            modelBuilder.Entity("DigitalMenu.Entity.Entities.DMRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("b5df88a8-30d3-48f1-bc87-4558d4e06b3a"),
                            RoleName = "Customer"
                        });
                });
            ...
            modelBuilder.Entity("DigitalMenu.Entity.Entities.DMUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9b04a6ba-cd42-4de6-85c5-6de4342e3478"),
                            CreatedAt = new DateTime(2021, 4, 4, 0, 2, 8, 100, DateTimeKind.Utc).AddTicks(460),
