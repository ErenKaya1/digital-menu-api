...
namespace DigitalMenu.Data.Migrations
{
    ...
    [Migration("20210408234057_asdasdasdsa")]
    partial class asdasdasdsa
    {
            ...
            modelBuilder.Entity("DigitalMenu.Entity.Entities.Culture", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f063aae2-a525-4b03-b754-b2de25add788"),
                            CultureCode = "tr",
                            IsDefaultCulture = true
                        },
                        new
                        {
                            Id = new Guid("b44c0b92-f16a-4fb2-a1e8-f9003208ed2a"),
                            CultureCode = "en",
            ...
            modelBuilder.Entity("DigitalMenu.Entity.Entities.DMRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("94b5d304-f58d-4a24-a4ae-98498f09a1ec"),
                            RoleName = "Customer"
                        });
                });
            ...
            modelBuilder.Entity("DigitalMenu.Entity.Entities.DMUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d2881d5e-48f8-46bd-9a5f-a67dec55cbda"),
                            CreatedAt = new DateTime(2021, 4, 8, 23, 40, 57, 333, DateTimeKind.Utc).AddTicks(4222),
            ...
            modelBuilder.Entity("DigitalMenu.Entity.Entities.Menu", b =>
                {
                    ...
                    b.Property<int>("QrCodeMargin")
                        .HasColumnType("integer");

                    b.Property<int>("QrCodeScale")
                        .HasColumnType("integer");
