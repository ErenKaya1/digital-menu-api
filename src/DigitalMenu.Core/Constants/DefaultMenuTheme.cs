...
{
    public static class DefaultMenuTheme
    {
        public const string BackgroundColor = "#F5F5F5";
        public const string TextColor = "#3B3E42";
        public const string PriceColor = "#3AB5A1";
        public const string CategoryDescriptionColor = "#C1C1C1";
