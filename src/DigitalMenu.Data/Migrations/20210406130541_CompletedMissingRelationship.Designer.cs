...
namespace DigitalMenu.Data.Migrations
{
    ...
    [Migration("20210406130541_CompletedMissingRelationship")]
    partial class CompletedMissingRelationship
    {
            ...
            modelBuilder.Entity("DigitalMenu.Entity.Entities.Culture", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5696be22-2eb2-43ec-b304-cc6d6f276ebe"),
                            CultureCode = "tr",
                            IsDefaultCulture = true
                        },
                        new
                        {
                            Id = new Guid("9bcb8710-e6ba-490e-9eec-52157bb334df"),
                            CultureCode = "en",
            ...
            modelBuilder.Entity("DigitalMenu.Entity.Entities.DMRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("e8a56f0a-d030-49ae-ad1a-ce71c6cb3db4"),
                            RoleName = "Customer"
                        });
                });
            ...
            modelBuilder.Entity("DigitalMenu.Entity.Entities.DMUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9a8a7cb0-9aca-4c4d-91ab-f0bd7a8ca1cd"),
                            CreatedAt = new DateTime(2021, 4, 6, 13, 5, 41, 588, DateTimeKind.Utc).AddTicks(1272),
