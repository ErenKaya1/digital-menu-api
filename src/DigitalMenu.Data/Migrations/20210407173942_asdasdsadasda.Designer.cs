...
namespace DigitalMenu.Data.Migrations
{
    ...
    [Migration("20210407173942_asdasdsadasda")]
    partial class asdasdsadasda
    {
            ...
            modelBuilder.Entity("DigitalMenu.Entity.Entities.Culture", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("50ea1e81-fe52-4f46-956b-a7bf30104019"),
                            CultureCode = "tr",
                            IsDefaultCulture = true
                        },
                        new
                        {
                            Id = new Guid("e358cf80-ae22-432f-b4b4-cc6afeb04f6d"),
                            CultureCode = "en",
            ...
            modelBuilder.Entity("DigitalMenu.Entity.Entities.DMRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("6b32047c-edee-4c10-8caf-cc87167b9b46"),
                            RoleName = "Customer"
                        });
                });
            ...
            modelBuilder.Entity("DigitalMenu.Entity.Entities.DMUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("07936122-7ff1-4cae-9816-e48d14d99155"),
                            CreatedAt = new DateTime(2021, 4, 7, 17, 39, 41, 640, DateTimeKind.Utc).AddTicks(8108),
