            ...
            modelBuilder.Entity("DigitalMenu.Entity.Entities.DMRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("0374f26b-fe54-484e-8a35-07ff6b07629d"),
                            RoleName = "Customer"
                        });
                });
            ...
            modelBuilder.Entity("DigitalMenu.Entity.Entities.DMUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b6804b18-f05a-49be-9ff9-4877cce17ca2"),
                            CreatedAt = new DateTime(2021, 4, 20, 22, 32, 24, 696, DateTimeKind.Utc).AddTicks(6447),
            ...
            modelBuilder.Entity("DigitalMenu.Entity.Entities.SubscriptionTypeFeatureTranslation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("63407d18-1b57-41de-a964-03cad8411ec7"),
                        ...
                        new
                        {
                            Id = new Guid("dcb553f5-cd3f-4361-ba0b-72c339e3cfcf"),
                        ...
                        new
                        {
                            Id = new Guid("907cf224-02fa-4542-9b32-a0232eeec0cf"),
                            CultureId = new Guid("48c92719-ebe7-4b4c-9814-9c8f1a57b1ff"),
                            Name = "Ürün",
                        ...
                        new
                        {
                            Id = new Guid("4f7a4ca8-9c95-4778-9b60-e4b22beda62c"),
                            CultureId = new Guid("41d8d90c-2224-42fb-ac80-c27b87e74371"),
                            Name = "Product",
                            SubscriptionTypeFeatureId = new Guid("9abf06ab-0c1a-4c63-a141-e512fe306c1e")
                        },
                        new
                        {
                            Id = new Guid("2fcb13c3-b330-4eb5-9e0a-efe2907cdf7a"),
                            CultureId = new Guid("48c92719-ebe7-4b4c-9814-9c8f1a57b1ff"),
                            Name = "Ürün",
                        ...
                        new
                        {
                            Id = new Guid("29069e03-a2a3-4800-82ac-5ed4263d2320"),
                            CultureId = new Guid("41d8d90c-2224-42fb-ac80-c27b87e74371"),
                            Name = "Product",
                            SubscriptionTypeFeatureId = new Guid("da12028f-418a-4bd2-9617-27c4aec8372c")
                        });
            ...
            modelBuilder.Entity("DigitalMenu.Entity.Entities.SubscriptionTypeTranslation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b6dcadb4-cf72-47b6-b698-d7b09fb9d2f1"),
                            CultureId = new Guid("48c92719-ebe7-4b4c-9814-9c8f1a57b1ff"),
                            SubscriptionTypeId = new Guid("638885d5-6b38-4c01-903a-449c676b86f5"),
                            Title = "Giriş"
                        },
                        new
                        {
                            Id = new Guid("fbf534b1-81e4-4862-89a7-8b3da60edc4b"),
                            CultureId = new Guid("41d8d90c-2224-42fb-ac80-c27b87e74371"),
                            SubscriptionTypeId = new Guid("638885d5-6b38-4c01-903a-449c676b86f5"),
                            Title = "Starter"
                        },
                        new
                        {
                            Id = new Guid("34cd4585-8a37-488c-b5e4-da6396041b03"),
                            CultureId = new Guid("48c92719-ebe7-4b4c-9814-9c8f1a57b1ff"),
                            SubscriptionTypeId = new Guid("971daed0-4c56-4e5b-b9a9-74eb975c54eb"),
                            Title = "Ekonomik"
                        },
                        new
                        {
                            Id = new Guid("a1d38006-b4a5-4543-b6f8-7477a3dba523"),
                            CultureId = new Guid("41d8d90c-2224-42fb-ac80-c27b87e74371"),
                            SubscriptionTypeId = new Guid("971daed0-4c56-4e5b-b9a9-74eb975c54eb"),
                            Title = "Economic"
                        },
                        new
                        {
                            Id = new Guid("d0787658-aca3-4848-8ff9-d16d0d2743be"),
                            CultureId = new Guid("48c92719-ebe7-4b4c-9814-9c8f1a57b1ff"),
                            SubscriptionTypeId = new Guid("e0f8c62e-9769-4520-a46b-2d23f6abe7e3"),
                            Title = "Premium"
                        },
                        new
                        {
                            Id = new Guid("f4c0dba8-da5a-4d74-93f5-fabab3176bf9"),
                            CultureId = new Guid("41d8d90c-2224-42fb-ac80-c27b87e74371"),
                            SubscriptionTypeId = new Guid("e0f8c62e-9769-4520-a46b-2d23f6abe7e3"),
                            Title = "Premium"
                        });
